...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/local/hacs-home-ledger?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hacs-home-ledger&category=integration)
...
1. Download the `custom_components/home_ledger/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=home_ledger)
...
Find all entities in **Settings** → **Devices & Services** → **Home Ledger** → click on the device.
...
```yaml
service: home_ledger.example_action
data:
  # Add your parameters here
```

### `home_ledger.reload_data`
...
```yaml
service: home_ledger.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Home Ledger → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@local][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/local/hacs-home-ledger.svg?style=for-the-badge
[commits]: https://github.com/local/hacs-home-ledger/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/local/hacs-home-ledger.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40local-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/local/hacs-home-ledger.svg?style=for-the-badge
[releases]: https://github.com/local/hacs-home-ledger/releases

...
5. Add this repository URL: `https://github.com/local/hacs-home-ledger`
...
1. Download the latest release from the [releases page](https://github.com/local/hacs-home-ledger/releases)
...
- Report issues at [GitHub Issues](https://github.com/local/hacs-home-ledger/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/local/hacs-home-ledger/discussions)

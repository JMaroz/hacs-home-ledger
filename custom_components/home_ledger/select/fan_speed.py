"""Fan speed select for home_ledger."""

from custom_components.home_ledger.api import FAN_SPEEDS, HomeLedgerApiClientError
...
class HomeLedgerFanSpeedSelect(SelectEntity, HomeLedgerEntity):

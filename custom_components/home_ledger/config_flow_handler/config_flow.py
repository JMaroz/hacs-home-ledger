"""Config flow for home_ledger — user setup, reconfigure and reauth."""
...
class HomeLedgerConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _async_validate(self, user_input: dict[str, Any]) -> dict[str, str]:
        ...
        except HomeLedgerApiClientAuthenticationError:
            return {"base": "invalid_auth"}
        except HomeLedgerApiClientCommunicationError:
